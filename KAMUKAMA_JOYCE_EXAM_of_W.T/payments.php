...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(PaymentID,ClientID , Amount,Date) VALUES (?, ?, ?,?)");
    $stmt->bind_param("isss", $PaymentID, $ClientID,$Amount,$Date);
    
    // Set parameters and execute
    $PaymentID = $_POST['book_id'];
    $ClientID = $_POST['ride_id'];
    $Amount = $_POST['passenger_id'];
